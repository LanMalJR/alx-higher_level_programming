#!/usr/bin/python3
'''
The Rectangle class is housed within the module.
'''
...
class Rectangle:
    ...
    Methods:
        ...
        __repr__(self): Returns the rectangle with the character #
        __str__(self): Returns the location of the rectangle in memory
    '''
    ...
    def __repr__(self):
        '''
        Returns the a string with the location of the rectangle in memory
